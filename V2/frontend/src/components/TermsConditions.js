    ...
    <div className="termsconditions-container">
      ...
      <div className="other-conditions-container">
        <div className="condition-container">
          <h3 onClick={() => toggleSection("section1")}>INFORMACIÓN RELEVANTE</h3>
          {sectionsVisible["section1"] && (
            <div>
              <p>
                Es requisito indispensable para la adquisición de los productos que se ofrecen en este sitio, que lea y acepte los siguientes Términos y Condiciones que a continuación se redactan. El uso de nuestros servicios así como la compra de nuestros productos implica que usted ha leído y aceptado los Términos y Condiciones de Uso en el presente documento. El usuario se responsabiliza por todas las acciones u omisiones realizadas en este sitio web.En algunos casos, para adquirir un producto, será necesario el registro por parte del usuario, con ingreso de sus datos personales verídicos y la definición de una contraseña.
              </p>
              <p>
        ...
        <div className="condition-container">
          <h3 onClick={() => toggleSection("section2")}>LICENCIA</h3>
          {sectionsVisible["section2"] && (
            <div>
              <p>
        ...
        <div className="condition-container">
          <h3 onClick={() => toggleSection("section3")}>USO NO AUTORIZADO</h3>
          {sectionsVisible["section3"] && (
            <div>
              <p>
        ...
        <div className="condition-container">
          <h3 onClick={() => toggleSection("section4")}>PROPIEDAD</h3>
          {sectionsVisible["section4"] && (
            <div>
              <p>
        ...
        <div className="condition-container">
          <h3 onClick={() => toggleSection("section4")}>PRIVACIDAD</h3>
          {sectionsVisible["section4"] && (
            <div>
              <p>
                Usted no puede declarar propiedad intelectual o exclusiva a ninguno de nuestros productos, modificado o sin modificar. Todos los productos son propiedad de los proveedores del contenido. En caso de que no se especifique lo contrario, nuestros productos se proporcionan sin ningún tipo de garantía, expresa o implícita. En ningún caso esta compañía será responsable de ningún daño incluyendo, pero no limitado a, daños directos, indirectos, especiales, fortuitos o consecuentes u otras pérdidas resultantes del uso o de la imposibilidad de utilizar nuestros productos
        ...
        <div className="condition-container">
          <h3 onClick={() => toggleSection("section5")}>VIOLACIONES DEL SISTEMA DE BASE DE DATOS</h3>
          {sectionsVisible["section5"] && (
            <div>
              <p>
        ...
        <div className="condition-container">
          <h3 onClick={() => toggleSection("section6")}>FALLAS DEL SISTEMA</h3>
          {sectionsVisible["section6"] && (
            <div>
              <p>
        ...
        <div className="condition-container">
          <h3 onClick={() => toggleSection("section7")}>ALCANCE DE LOS SERVICIOS DE PROWESS AGRÍCOLA</h3>
          {sectionsVisible["section7"] && (
            <div>
              <p>
        ...
        <div className="condition-container">
          <h3 onClick={() => toggleSection("section8")}>REGISTRO DE USUARIOS</h3>
          {sectionsVisible["section8"] && (
            <div>
              <p>
        ...
        <div className="condition-container">
          <h3 onClick={() => toggleSection("section9")}>EDAD Y CAPACIDAD LEGAL </h3>
          {sectionsVisible["section9"] && (
            <div>
              <p>
        ...
        <div className="condition-container">
          <h3 onClick={() => toggleSection("section10")}>TIEMPO DE CONSERVACIÓN DE DATOS DE USUARIOS</h3>
          {sectionsVisible["section10"] && (
            <div>
              <p>
        ...
        <div className="condition-container">
          <h3 onClick={() => toggleSection("section11")}>DEVOLUCIÓN DE PRODUCTOS</h3>
          {sectionsVisible["section11"] && (
            <div>
              <p>
        ...
        <div className="condition-container">
          <h3 onClick={() => toggleSection("section12")}>USO DE LOS SERVICIOS DEL SITIO WEB</h3>
          {sectionsVisible["section12"] && (
            <div>
              <p>
        ...
        <div className="condition-container">
          <h3 onClick={() => toggleSection("section13")}>LOS USUARIOS DEBERÁN ABSTENERSE DE</h3>
          {sectionsVisible["section13"] && (
            <div>
              <p>
        ...
        <div className="condition-container">
          <h3 onClick={() => toggleSection("section14")}>SUSPENSIÓN O REVOCACIÓN DEL USUARIO</h3>
          {sectionsVisible["section14"] && (
            <div>
              <p>
        ...
        <div className="condition-container">
          <h3 onClick={() => toggleSection("section15")}>PROPIEDAD INTELECTUAL E INDUSTRIAL</h3>
          {sectionsVisible["section15"] && (
            <div>
              <p>
        ...
        <div className="condition-container">
          <h3 onClick={() => toggleSection("section16")}>SOBRE COMPRA Y VENTA DE PRODUCTOS</h3>
          {sectionsVisible["section16"] && (
            <div>
        ...
        <div className="condition-container">
          <h3 onClick={() => toggleSection("section17")}>MODIFICACIONES DEL ACUERDO</h3>
          {sectionsVisible["section17"] && (
            <div>
        ...
        <div className="condition-container">
          <h3 onClick={() => toggleSection("section18")}>SANCIONES</h3>
          {sectionsVisible["section18"] && (
            <div>
        ...
        <div className="condition-container">
          <h3 onClick={() => toggleSection("section19")}>JURISDICCIÓN Y LEY APLICABLE</h3>
          {sectionsVisible["section19"] && (
            <div>
