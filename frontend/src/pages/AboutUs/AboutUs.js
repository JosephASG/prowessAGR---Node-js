...
function AboutUs() {
  return (
    <Container className='AboutUsInfo'>
      <Row className='mb-4'>
        <Col>
          <h1 style={{textShadow:"none", fontFamily: "Roboto", WebkitTextStroke: "1.5px white", color: "white"}}>ACERCA DE NOSOTROS</h1>
      ...
      <Row className='about-section mb-4'>
        <Col md={12}>
          <h2 style={{textShadow:"none", fontFamily: "Roboto", WebkitTextStroke: "1.5px white", color: "white"}}>¿Quienes Somos?</h2>
      ...
      <Row className='about-section mb-4'>
        <Col md={6}>
          <h2 style={{textShadow:"none", fontFamily: "Roboto", WebkitTextStroke: "1.5px white", color: "white"}}>Misión</h2>
        ...
        <Col md={6}>
          <h2 style={{textShadow:"none", fontFamily: "Roboto", WebkitTextStroke: "1.5px white", color: "white"}}>Visión</h2>
      ...
      <Row className='about-section mb-4'>
        <Col md={6}>
          <h2 style={{textShadow:"none", fontFamily: "Roboto", WebkitTextStroke: "1.5px white", color: "white"}}>Objetivos Generales</h2>
        ...
        <Col md={6}>
          <h2 style={{textShadow:"none", fontFamily: "Roboto", WebkitTextStroke: "1.5px white", color: "white"}}>Objetivos Específicos</h2>
          <ul>
